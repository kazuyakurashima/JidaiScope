# 031: Event Detail Screen（Sprint 3）
...
- ✅ 関連リンク（人物→032, イベント→031）でシームレス遷移
- ✅ ブックマークボタン機能
- ✅ オフライン環境で動作
...
| 種類         | 詳細                                                |
| ------------ | --------------------------------------------------- |
| ✓ 入力依存   | 012 (Database), 011 (Navigation), 020 (Timeline)    |
| ✗ コード依存 | 032 (Person Detail) へ遷移                          |
| ✓ 出力依存   | 033 (Source Display) が本チケットの事件詳細内に統合 |
