...
> **⚠️ 統合通知:** 本チケットは [038 EraPickerBar Redesign](038-era-picker-redesign.md) に統合されました。
> 実装は 038 を参照してください。
...
### v4.0 (2026-01-31)
- 038 EraPickerBar Redesign に統合
- 本チケットの機能は038の自動スクロール機能として実装予定
