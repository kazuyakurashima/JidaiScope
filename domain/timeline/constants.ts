...
/**
 * 進行中在位の暫定終了年
 * 今上天皇など現在進行中の在位期間に使用する仮の終了年。
 * タイムライン描画範囲を超える十分先の年を設定。
 * データ整合性のため、この値を変更する際は reigns.json も更新すること。
 */
export const ONGOING_REIGN_END_YEAR = 2100;
...
export const LOD_THRESHOLDS = {
  /** L0 の排他的上限（zoom < 2 → L0） */
  L0_MAX: 2,
  /** L1 の排他的上限（zoom < 10 → L1） */
  L1_MAX: 10,
  /** L2 の排他的上限（zoom < 50 → L2） */
  L2_MAX: 50,
} as const;
